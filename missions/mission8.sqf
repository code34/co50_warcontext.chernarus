...
private [
	...
	_sourceposition = [wcmaptopright, wcmapbottomleft] call func_createposition;
	...
	call compile format ["_trg setTriggerStatements[""this or count thislist < 5"", ""
		nil = [%2] call func_deletemarker;
		wcmissionclear = true;
		publicvariable 'wcmissionclear';
	"", """"];", wclevel, _markername];

	_position = [_markername] call func_createpositioninmarker;
	...
	_markernameAA = "AA1";
	_markersize = 50;
	nil = [_markernameAA, _markersize, _position, 'ColorRED', 'ELLIPSE', 'FDIAGONAL'] call func_createmarker;
