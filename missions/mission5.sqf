	...
	wcmissiondescriptionW = "In few days, Russian Army will receive an important stock of Ammo. As there no other way to do, you must destroy the building that will receipt it.";
	wcmissiondescriptionE = "You must put ammo stock on a building";
